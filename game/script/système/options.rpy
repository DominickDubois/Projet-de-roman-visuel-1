...
define config.name = _("Je suis tombé amoureux d'un androïde sans émotion...")
...
define gui.about = _p("""C'est la nouvelle année scolaire, avec un tas de nouveaux étudiants qui se joignent, comme d'habitude. Cependant, une fille attire l'attention d'Alexandre Dupont, âgé de 17 ans. Il s'avère qu'elle est un androïde humanoïde! Cela ne l'empêche pas d'essayer de devenir ami avec la fille, mais dans le processus, il réalise qu'il veut être plus que des amis...

Ce jeu est en phase de test alpha. Il peut y avoir des bogues et une histoire incomplète. Veuillez me signaler tout problème par e-mail à dominickdubois@hotmail.com. Merci.
""")
...
define config.save_directory = "JSTADASE-1690070893"
